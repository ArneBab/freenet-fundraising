...
#+BEGIN_SRC sh
wget 'https://freenetproject.org/jnlp/freenet_installer.jar' -O new_installer.jar
java -jar new_installer.jar -console
# (follow the prompts)
# info: https://freenetproject.org/download.html
./run.sh # { console | start | stop | restart | status | dump }
#+END_SRC

as seednode: https://piratenpad.de/p/pirates4freenet
