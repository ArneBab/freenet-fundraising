...
#+BEGIN_SRC python :tangle routingsim.py :exports none :results output
  ...
  plotlinklengths(randomnets+smallworldnets, "Link lengths", 
           filepath="size-{}-peers-{}-hash-{}-linklengths.png".format(
             len(locs), outdegree, hash(tuple(locs))))
  plotring(locs, randompaths, "random paths", 
           filepath="size-{}-peers-{}-hash-{}-meanlen-{}-random.png".format(
             len(locs), outdegree, hash(tuple(locs)), int(numpy.mean(randompathlens))))
  plotring(locs, smallworldpaths, "small world paths", 
           filepath="size-{}-peers-{}-hash-{}-meanlen-{}-smallworld.png".format(
             len(locs), outdegree, hash(tuple(locs)), int(numpy.mean(smallworldpathlens))))
...
#+RESULTS:
: random: [199, 17, 138, 29, 384, 130, 108, 25, 23, 10]
: small world: [6, 6, 7, 7, 2, 3, 8, 6, 6, 9]
