...
Freenet is unique in that it *already provides* spam-resistant, anonymous communication and publication without the need to maintain a powerful server and with availability for stuff users access - and it has a proven track record of providing this since 2000. It just needs to be made easier to use to restore privacy in online communication and publishing.
