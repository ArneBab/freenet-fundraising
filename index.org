...
This is the focus we all subscribe to, but the last 14 years showed that with the current pace of development it will be very hard to achieve it fast enough to make a difference before control by of the web by a few big actors gets so strong that people cannot even spread the word about Freenet anymore. And this is why we ask you for your help.
