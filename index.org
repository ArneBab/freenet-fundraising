...
We are a diverse team of about a dozen developers around the world. While we all have different goals, we all subscribe to the common mission of providing the technical foundation for freedom of the press in the internet. Our focus is best captured in the following quote from Mike Godwin:
